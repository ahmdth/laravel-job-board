        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="-my-6">
                <div class="flex flex-wrap md:flex-nowrap">
                    <div class="content dark:text-gray-400 w-full md:w-3/4 pr-4 leading-relaxed text-base">
                        {!! $listing->content !!}
                    </div>
                    <div class="w-full md:w-1/4 pl-4">
                        ...
                        <a href="{{ route('listings.apply', $listing->slug) }}" class="block text-center my-4 tracking-wide bg-white dark:bg-gray-900 text-indigo-500 text-sm font-medium title-font py-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white uppercase">Apply Now</a>
                    </div>
                </div>
            </div>
        </div>
